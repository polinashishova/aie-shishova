...
| Тип | Файлы | Описание |
|-----|-------|----------|
| **Unit-тесты** | `test_utils.py`, `test_data.py`, `test_models.py` | Проверка изолированных функций |
| **Интеграционные тесты** | `test_api/test_health.py`, `test_api/test_predict.py` | Проверка API эндпоинтов |
| **Тесты с моками** | `test_models.py`, `test_api/test_predict.py` | Проверка с подменой зависимостей |
