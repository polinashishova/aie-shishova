...
def report(
    ...
    top_k_categories: int = typer.Option(5, help='Количество выводимых значений для категориальных признаков.'),
    ...
    with md_path.open("w", encoding="utf-8") as f:
        ...
        f.write(f"- Есть колонки с постоянными значениями: **{quality_flags['has_constant_columns']}**\n")
        f.write(f"- Есть категориальные колонки со слишком большим числом уникальных значений: **{quality_flags['has_high_cardinality_categoricals']}**\n\n")
