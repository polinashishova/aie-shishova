...
Какие модели сравнивали и какие гиперпараметры подбирали:
...
Наиболее важны по permutation importance первые 6-10 признаков в таблице, остальные влияют на выбранную метрику (average precision) не так незначительно.
